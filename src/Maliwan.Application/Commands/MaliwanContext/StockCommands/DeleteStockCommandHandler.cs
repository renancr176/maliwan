...
public class DeleteStockCommandHandler : IRequestHandler<DeleteStockCommand, bool>
{
    ...
    public DeleteStockCommandHandler(IMediator mediator, IHttpContextAccessor httpContextAccessor,
    ...
    public async Task<bool> Handle(DeleteStockCommand command, CancellationToken cancellationToken)
    {
        try
        {
